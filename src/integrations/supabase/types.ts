  ...
  public: {
    Tables: {
      ...
      hub_rop_nonces: {
        ...
        Relationships: [
          {
            foreignKeyName: "hub_rop_nonces_app_id_fkey";
            columns: ["app_id"];
            isOneToOne: false;
            referencedRelation: "hub_apps";
            referencedColumns: ["id"];
      ...
      bridge_audit_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "bridge_audit_events_device_id_fkey";
            columns: ["device_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "bridge_audit_events_job_id_fkey";
            columns: ["job_id"];
            isOneToOne: false;
            referencedRelation: "bridge_jobs";
            referencedColumns: ["id"];
          },
        ];
      };
      ...
      bridge_jobs: {
        Row: {
          ...
          status: Database["public"]["Enums"]["bridge_job_status"];
          tool_name: string;
          user_id: string;
        ...
        Relationships: [
          {
            foreignKeyName: "bridge_jobs_device_id_fkey";
            columns: ["device_id"];
            isOneToOne: false;
            referencedRelation: "bridge_devices";
            referencedColumns: ["id"];
      ...
      bridge_tool_grants: {
        ...
        Relationships: [
          {
            foreignKeyName: "bridge_tool_grants_device_id_fkey";
            columns: ["device_id"];
            isOneToOne: false;
            referencedRelation: "bridge_devices";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      bridge_approve_job: {
        Args: { _approved: boolean; _job_id: string };
        Returns: Json;
      };
      bridge_cancel_job: {
        Args: { _client_id: string; _job_id: string };
        Returns: Json;
      };
      bridge_connector_claim_job: {
        Args: { _device_id: string };
        Returns: Json;
      };
      bridge_connector_complete_job: {
        Args: {
          _device_id: string;
          _error?: string;
          _job_id: string;
      ...
      bridge_connector_heartbeat: {
        Args: { _device_id: string };
        Returns: undefined;
      };
      bridge_devices_for_caller: {
      ...
      bridge_rnd_agent_claim_job: {
        Args: { _device_id: string };
        Returns: Json;
      };
      bridge_rnd_agent_complete_job: {
        Args: {
          _device_id: string;
          _error?: string;
          _job_id: string;
      ...
      bridge_rnd_agent_heartbeat: {
        Args: { _device_id: string; _metadata?: Json };
        Returns: Json;
      };
    };
    Enums: {
