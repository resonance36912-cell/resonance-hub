...
export const APP_META: Record<AppKey, { label: string; accent: string; url: string }> = {
  ...
  creative_studio:   { label: "Resonance Creative Studio", accent: "#a855f7", url: "https://resonancestudio.life" },
  sync_vision:       { label: "Resonance Sync Vision",     accent: "#ec4899", url: "https://resonancesyncvision.life" },
  youtube_optimizer: { label: "YouTube Optimizer",         accent: "#06b6d4", url: "https://optimizer.resonance.life" },
