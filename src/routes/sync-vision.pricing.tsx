...
export const Route = createFileRoute("/sync-vision/pricing")({
  head: () => ({
    meta: [
      { title: "Sync Vision Pricing — The Resonance" },
      {
        name: "description",
        content:
          "Resonance Sync Vision pricing: Creator R549/mo, Pro R1,399/mo, Business R2,799/mo. ZAR · PayFast · cancel anytime.",
      },
      { property: "og:title", content: "Sync Vision Pricing — The Resonance" },
      {
        property: "og:description",
        content:
          "Paid plans from R549/month. AI storyboards, character performances, HD renders. PayFast checkout via the Hub.",
      },
    ],
  }),
  component: SyncVisionPricingPage,
});
...
const plans: Plan[] = [
  {
    ...
    zar: "R549",
    cadence: "/ month",
    blurb: "First storyboards",
    features: ["AI storyboards", "Watermarked previews"],
    cta: "Subscribe",
    href: "/checkout?app=sync_vision&plan=creator",
  },
  {
    name: "Pro",
    zar: "R1,399",
    cadence: "/ month",
    blurb: "Most popular",
    features: ["Character performances", "HD renders"],
    cta: "Subscribe",
    href: "/checkout?app=sync_vision&plan=pro",
    featured: true,
  },
  {
    name: "Business",
    ...
    cadence: "/ month",
    blurb: "Studios",
    features: ["Multi-artist projects", "Priority queue"],
    cta: "Subscribe",
    href: "/checkout?app=sync_vision&plan=business",
  },
];

function SyncVisionPricingPage() {
  return (
    <div className="min-h-screen text-foreground selection:bg-[hsl(325_90%_65%/0.3)]">
      ...
      <main className="pt-28 pb-24 px-6 max-w-5xl mx-auto">
        <section className="text-center mb-16 animate-reveal">
          <div className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.25em] text-white/60 border border-white/10 rounded-full px-4 py-1.5 mb-6">
            <span
              className="size-1.5 rounded-full shadow-[0_0_10px_hsl(325_90%_65%)]"
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-[0.95] mb-6">
            Sync{" "}
            <span className="font-serif italic font-normal text-white/80">Vision</span>
          </h1>
          <p className="text-lg text-white/65 max-w-2xl mx-auto leading-relaxed">
            Plan AI-driven music videos and cinematic storyboards. Monthly billing in ZAR.
            Cancel anytime.
          </p>
        </section>
            ...
            {plans.map((p) => (
              <article
                ...
                className={`relative rounded-2xl border p-6 flex flex-col backdrop-blur-xl transition-all duration-300 ${
                  p.featured
                    ? "border-[hsl(325_90%_65%/0.45)] bg-gradient-to-b from-[hsl(325_90%_65%/0.08)] to-card/60 shadow-[0_0_50px_-15px_hsl(325_90%_65%/0.6)]"
              ...
              >
                ...
                <a
                  ...
                  className={`text-center px-4 py-2.5 rounded-full text-xs font-bold uppercase tracking-widest transition-all ${
                    p.featured
                      ? "bg-gradient-brand text-white shadow-[0_0_25px_-8px_hsl(325_90%_65%/0.8)]"
        ...
        <section className="text-center animate-reveal" style={{ animationDelay: "200ms" }}>
          <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-gradient-to-br from-[hsl(325_90%_65%/0.12)] via-[hsl(295_90%_60%/0.08)] to-[hsl(265_85%_65%/0.12)] backdrop-blur-xl p-8 md:p-12">
            <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-[hsl(325_90%_65%/0.20)] blur-3xl" />
