...
export const Route = createFileRoute("/epublisher/pricing")({
  head: () => ({
    meta: [
      { title: "ePublisher Pricing — The Resonance" },
      {
        name: "description",
        content:
          "Resonance ePublisher pricing: Free, Starter R99/mo, Creator R199/mo, Pro R449/mo, Business R999/mo. ZAR · PayFast · cancel anytime.",
      },
      { property: "og:title", content: "ePublisher Pricing — The Resonance" },
      {
        property: "og:description",
        content:
          "Free tier + paid plans from R99/month. Audiovisual books, audio narration, custom voices. PayFast checkout via the Hub.",
      },
    ],
  }),
  component: EpublisherPricingPage,
});
...
const plans: Plan[] = [
  {
    ...
    zar: "R0",
    cadence: "forever",
    blurb: "Try the editor",
    features: ["1 project", "Watermarked exports"],
    cta: "Start free",
  ...
  },
  {
    ...
    cadence: "/ month",
    blurb: "Solo writers",
    features: ["3 projects", "ePub export"],
    cta: "Subscribe",
    href: "/checkout?app=epublisher&plan=starter",
  },
  {
    name: "Creator",
    zar: "R199",
    cadence: "/ month",
    blurb: "Most popular",
    features: ["10 projects", "Audio narration", "AV exports"],
    cta: "Subscribe",
    href: "/checkout?app=epublisher&plan=creator",
    featured: true,
  },
  {
    name: "Pro",
    ...
    cadence: "/ month",
    blurb: "Full toolkit",
    features: ["Unlimited projects", "Custom voices"],
    cta: "Subscribe",
    href: "/checkout?app=epublisher&plan=pro",
  },
  {
    name: "Business",
    zar: "R999",
    cadence: "/ month",
    blurb: "Teams & imprints",
    features: ["Team seats", "Priority support"],
    cta: "Subscribe",
    href: "/checkout?app=epublisher&plan=business",
  },
];

function EpublisherPricingPage() {
  return (
      ...
      <main className="pt-28 pb-24 px-6 max-w-6xl mx-auto">
        <section className="text-center mb-16 animate-reveal">
          <div className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.25em] text-white/60 border border-white/10 rounded-full px-4 py-1.5 mb-6">
            <span
              className="size-1.5 rounded-full shadow-[0_0_10px_hsl(295_90%_60%)]"
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-[0.95] mb-6">
            Resonance{" "}
            <span className="font-serif italic font-normal text-white/80">ePublisher</span>
          </h1>
          <p className="text-lg text-white/65 max-w-2xl mx-auto leading-relaxed">
            Turn written stories into immersive audiovisual books. Monthly billing in ZAR.
            Cancel anytime.
          </p>
        </section>
        ...
        <section className="text-center animate-reveal" style={{ animationDelay: "200ms" }}>
          <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-gradient-to-br from-[hsl(295_90%_60%/0.12)] via-[hsl(265_85%_65%/0.08)] to-[hsl(325_90%_65%/0.12)] backdrop-blur-xl p-8 md:p-12">
            <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-[hsl(295_90%_60%/0.20)] blur-3xl" />
